...
>- 예약자 이름, 예약 날짜 및 시간, 예약 일자, 예약 시간, 예약 장소로 기존 예약 정보를 검색할 수 있습니다.
>- 파일 입출력도 지원합니다.


## 5. 개발환경 및 언어
>- 개발환경: Visual Studio Code, CMake, gcc, Windows
>- 개발언어: C
...
> ### 역할 분담
>>- 안준용: SearchReservation() 구현   
>>- 양시준: main.c 구현, CRUD 함수 구현, 메뉴 함수 구현, 검색 함수 구현, 파일 입출력 함수 구현, dateTime 구조체 및 관련 함수 구현, field 관련 구조체 및 함수 구현, 코드 형식 통일 시키기   
